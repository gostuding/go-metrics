...
type MetricsClient interface {
	AddMetrics(ctx context.Context, in *MetricsRequest, opts ...grpc.CallOption) (*MetricsResponse, error)
}
...
func (c *metricsClient) AddMetrics(ctx context.Context, in *MetricsRequest, opts ...grpc.CallOption) (*MetricsResponse, error) {
...
type MetricsServer interface {
	AddMetrics(context.Context, *MetricsRequest) (*MetricsResponse, error)
...
func (UnimplementedMetricsServer) AddMetrics(context.Context, *MetricsRequest) (*MetricsResponse, error) {
...
func _Metrics_AddMetrics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MetricsServer).AddMetrics(ctx, req.(*MetricsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
